...
{
    unsafe class DLL_UnityEngine_Transform_Binding
    {
        ...
        static StackObject* set_parent_21(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if (!DllCLRBindings.CheckHasDontDestroyComponentInParent(value.gameObject, DllCLRBindings.ObjectOpration.Modified, "UnityEngine.Transform.set_parent"))
            {
        ...
        static StackObject* SetParent_22(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if (!DllCLRBindings.CheckHasDontDestroyComponentInParent(@p.gameObject, DllCLRBindings.ObjectOpration.Modified, "UnityEngine.Transform.SetParent"))
            {
        ...
        static StackObject* SetParent_23(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if (!DllCLRBindings.CheckHasDontDestroyComponentInParent(@parent.gameObject, DllCLRBindings.ObjectOpration.Modified, "UnityEngine.Transform.SetParent"))
            {
        ...
        static StackObject* DetachChildren_58(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if (!DllCLRBindings.CheckHasDontDestroyComponentInParent(instance_of_this_method.gameObject, DllCLRBindings.ObjectOpration.Modified, "UnityEngine.Transform.DetachChildren"))
            {
