...
{
    unsafe class DLL_UnityEngine_GameObject_Binding
    {
        ...
        static StackObject* AddComponent_17(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Component result_of_this_method = null;

            if (!DllCLRBindings.CheckHasDontDestroyComponentInParent(instance_of_this_method, DllCLRBindings.ObjectOpration.Modified, "UnityEngine.GameObject.AddComponent"))
            {
                result_of_this_method = instance_of_this_method.AddComponent(@componentType);
            }
