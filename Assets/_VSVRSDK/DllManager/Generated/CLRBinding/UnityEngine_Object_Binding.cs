...
{
    unsafe class DLL_UnityEngine_Object_Binding
    {
        ...
        static StackObject* Instantiate_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Object result_of_this_method = null;
            if (!DllCLRBindings.CheckHasDontDestroyComponentInParent(@parent.gameObject, DllCLRBindings.ObjectOpration.Modified, "UnityEngine.Object.Instantiate"))
            {
                result_of_this_method = UnityEngine.Object.Instantiate(@original, @position, @rotation, @parent);
            }
        ...
        static StackObject* Destroy_11(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if(!DllCLRBindings.CheckHasDontDestroyComponentInParent(@obj, DllCLRBindings.ObjectOpration.Delete, "UnityEngine.Object.Destroy"))
            {
        ...
        static StackObject* DestroyImmediate_13(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if (!DllCLRBindings.CheckHasDontDestroyComponentInParent(@obj, DllCLRBindings.ObjectOpration.Delete, "UnityEngine.Object.DestroyImmediate"))
            {
        ...
        static StackObject* DontDestroyOnLoad_16(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            UnityEngine.Debug.LogError("UnityEngine.Object.DontDestroyOnLoad is disable");

            return __ret;
        }

        static StackObject* get_hideFlags_17(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* FindObjectOfType_19(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* ToString_20(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* op_Equality_21(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
