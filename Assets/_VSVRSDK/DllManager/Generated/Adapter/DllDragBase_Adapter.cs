...
{   
    public class DllDragBaseAdapter : CrossBindingAdaptor
    {
        ...
        public class Adapter : global::DllDragBase, CrossBindingAdaptorType
        {
            ...
            {
                if (mOnDrag_61.CheckShouldInvokeBase(this.instance))
                    base.OnDrag(eventData);
                else
                    mOnDrag_61.Invoke(this.instance, eventData);
            }

            public override void OnBeginDrag(UnityEngine.EventSystems.PointerEventData eventData)
            {
                if (mOnBeginDrag_62.CheckShouldInvokeBase(this.instance))
                    base.OnBeginDrag(eventData);
                else
                    mOnBeginDrag_62.Invoke(this.instance, eventData);
            }

            public override void OnEndDrag(UnityEngine.EventSystems.PointerEventData eventData)
            {
                if (mOnEndDrag_63.CheckShouldInvokeBase(this.instance))
                    base.OnEndDrag(eventData);
                else
                    mOnEndDrag_63.Invoke(this.instance, eventData);
            }
