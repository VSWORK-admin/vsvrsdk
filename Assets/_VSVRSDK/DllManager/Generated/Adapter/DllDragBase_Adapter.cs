...
{   
    public class DllDragBaseAdapter : CrossBindingAdaptor
    {
        ...
        CrossBindingMethodInfo<UnityEngine.EventSystems.PointerEventData> mOnDrag_61 = new CrossBindingMethodInfo<UnityEngine.EventSystems.PointerEventData>("OnDrag");
        CrossBindingMethodInfo<UnityEngine.EventSystems.PointerEventData> mOnBeginDrag_62 = new CrossBindingMethodInfo<UnityEngine.EventSystems.PointerEventData>("OnBeginDrag");
        CrossBindingMethodInfo<UnityEngine.EventSystems.PointerEventData> mOnEndDrag_63 = new CrossBindingMethodInfo<UnityEngine.EventSystems.PointerEventData>("OnEndDrag");

        static DllDragBaseAdapter Instance = null;
        public DllDragBaseAdapter()
        {
            Instance = this;
        }
        public override Type BaseCLRType
        {
            get
            {
                return typeof(global::DllDragBase);
            }
        }
        ...
        public class Adapter : global::DllDragBase, CrossBindingAdaptorType
        {
            ...
            {
                if (Instance.mOnApplicationFocus_12.CheckShouldInvokeBase(this.instance))
                    base.OnApplicationFocus(focus);
                else
                    Instance.mOnApplicationFocus_12.Invoke(this.instance, focus);
            }

            public override void OnApplicationPause(System.Boolean pause)
            {
                if (Instance.mOnApplicationPause_13.CheckShouldInvokeBase(this.instance))
                    base.OnApplicationPause(pause);
                else
                    Instance.mOnApplicationPause_13.Invoke(this.instance, pause);
            }

            public override void OnApplicationQuit()
            {
                if (Instance.mOnApplicationQuit_14.CheckShouldInvokeBase(this.instance))
                    base.OnApplicationQuit();
                else
                    Instance.mOnApplicationQuit_14.Invoke(this.instance);
            }

            public override void OnAudioFilterRead(System.Single[] data, System.Int32 channels)
            {
                if (Instance.mOnAudioFilterRead_15.CheckShouldInvokeBase(this.instance))
                    base.OnAudioFilterRead(data, channels);
                else
                    Instance.mOnAudioFilterRead_15.Invoke(this.instance, data, channels);
            }

            public override void OnBecameInvisible()
            {
                if (Instance.mOnBecameInvisible_16.CheckShouldInvokeBase(this.instance))
                    base.OnBecameInvisible();
                else
                    Instance.mOnBecameInvisible_16.Invoke(this.instance);
            }

            public override void OnBecameVisible()
            {
                if (Instance.mOnBecameVisible_17.CheckShouldInvokeBase(this.instance))
                    base.OnBecameVisible();
                else
                    Instance.mOnBecameVisible_17.Invoke(this.instance);
            }

            public override void OnBeforeTransformParentChanged()
            {
                if (Instance.mOnBeforeTransformParentChanged_18.CheckShouldInvokeBase(this.instance))
                    base.OnBeforeTransformParentChanged();
                else
                    Instance.mOnBeforeTransformParentChanged_18.Invoke(this.instance);
            }

            public override void OnCanvasGroupChanged()
            {
                if (Instance.mOnCanvasGroupChanged_19.CheckShouldInvokeBase(this.instance))
                    base.OnCanvasGroupChanged();
                else
                    Instance.mOnCanvasGroupChanged_19.Invoke(this.instance);
            }

            public override void OnCollisionEnter(UnityEngine.Collision collision)
            {
                if (Instance.mOnCollisionEnter_20.CheckShouldInvokeBase(this.instance))
                    base.OnCollisionEnter(collision);
                else
                    Instance.mOnCollisionEnter_20.Invoke(this.instance, collision);
            }

            public override void OnCollisionEnter2D(UnityEngine.Collision2D collision)
            {
                if (Instance.mOnCollisionEnter2D_21.CheckShouldInvokeBase(this.instance))
                    base.OnCollisionEnter2D(collision);
                else
                    Instance.mOnCollisionEnter2D_21.Invoke(this.instance, collision);
            }

            public override void OnCollisionExit(UnityEngine.Collision collision)
            {
                if (Instance.mOnCollisionExit_22.CheckShouldInvokeBase(this.instance))
                    base.OnCollisionExit(collision);
                else
                    Instance.mOnCollisionExit_22.Invoke(this.instance, collision);
            }

            public override void OnCollisionExit2D(UnityEngine.Collision2D collision)
            {
                if (Instance.mOnCollisionExit2D_23.CheckShouldInvokeBase(this.instance))
                    base.OnCollisionExit2D(collision);
                else
                    Instance.mOnCollisionExit2D_23.Invoke(this.instance, collision);
            }

            public override void OnCollisionStay(UnityEngine.Collision collision)
            {
                if (Instance.mOnCollisionStay_24.CheckShouldInvokeBase(this.instance))
                    base.OnCollisionStay(collision);
                else
                    Instance.mOnCollisionStay_24.Invoke(this.instance, collision);
            }

            public override void OnCollisionStay2D(UnityEngine.Collision2D collision)
            {
                if (Instance.mOnCollisionStay2D_25.CheckShouldInvokeBase(this.instance))
                    base.OnCollisionStay2D(collision);
                else
                    Instance.mOnCollisionStay2D_25.Invoke(this.instance, collision);
            }

            public override void OnConnectedToServer()
            {
                if (Instance.mOnConnectedToServer_26.CheckShouldInvokeBase(this.instance))
                    base.OnConnectedToServer();
                else
                    Instance.mOnConnectedToServer_26.Invoke(this.instance);
            }

            public override void OnControllerColliderHit(UnityEngine.ControllerColliderHit hit)
            {
                if (Instance.mOnControllerColliderHit_27.CheckShouldInvokeBase(this.instance))
                    base.OnControllerColliderHit(hit);
                else
                    Instance.mOnControllerColliderHit_27.Invoke(this.instance, hit);
            }

            public override void OnDrawGizmos()
            {
                if (Instance.mOnDrawGizmos_28.CheckShouldInvokeBase(this.instance))
                    base.OnDrawGizmos();
                else
                    Instance.mOnDrawGizmos_28.Invoke(this.instance);
            }

            public override void OnGUI()
            {
                if (Instance.mOnGUI_29.CheckShouldInvokeBase(this.instance))
                    base.OnGUI();
                else
                    Instance.mOnGUI_29.Invoke(this.instance);
            }

            public override void OnJointBreak(System.Single breakForce)
            {
                if (Instance.mOnJointBreak_30.CheckShouldInvokeBase(this.instance))
                    base.OnJointBreak(breakForce);
                else
                    Instance.mOnJointBreak_30.Invoke(this.instance, breakForce);
            }

            public override void OnJointBreak2D(UnityEngine.Joint2D joint)
            {
                if (Instance.mOnJointBreak2D_31.CheckShouldInvokeBase(this.instance))
                    base.OnJointBreak2D(joint);
                else
                    Instance.mOnJointBreak2D_31.Invoke(this.instance, joint);
            }
            ...
            {
                if (Instance.mOnDrag_61.CheckShouldInvokeBase(this.instance))
                    base.OnDrag(eventData);
                else
                    Instance.mOnDrag_61.Invoke(this.instance, eventData);
            }

            public override void OnBeginDrag(UnityEngine.EventSystems.PointerEventData eventData)
            {
                if (Instance.mOnBeginDrag_62.CheckShouldInvokeBase(this.instance))
                    base.OnBeginDrag(eventData);
                else
                    Instance.mOnBeginDrag_62.Invoke(this.instance, eventData);
            }

            public override void OnEndDrag(UnityEngine.EventSystems.PointerEventData eventData)
            {
                if (Instance.mOnEndDrag_63.CheckShouldInvokeBase(this.instance))
                    base.OnEndDrag(eventData);
                else
                    Instance.mOnEndDrag_63.Invoke(this.instance, eventData);
            }
