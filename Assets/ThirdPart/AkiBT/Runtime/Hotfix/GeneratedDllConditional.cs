...
[AkiInfo("Conditional : Templete")]
[AkiLabel("GeneratedDllConditional : Templete")]
//[AkiGroup("GeneratedDllConditional")]
public class GeneratedDllConditional : Kurisu.AkiBT.Conditional
{
    ...
    public DllConditionalBase DllClass
    {
        get
        {
            ...
            try
            {
                if (DllManager.appdomain == null && !string.IsNullOrEmpty(DllName.Value))
                {
                    if (MultiDllManager.Instance != null && MultiDllManager.Instance.AllDllInstance.ContainsKey(DllName.Value))
                    {
                        ...
                        {
                            GenClass = MultiDllManager.Instance.AllDllInstance[DllName.Value].appdomain.Instantiate<DllConditionalBase>(ScriptClassName.Value);
                        }
                ...
                else
                {
                    if (GenClass == null && !string.IsNullOrEmpty(ScriptClassName.Value))
                    {
                        GenClass = DllManager.appdomain.Instantiate<DllConditionalBase>(ScriptClassName.Value);
                    }
    ...
    private DllConditionalBase GenClass = null;
    ~GeneratedDllConditional()
    {
        if (GenClass != null)
        {
            GenClass = null;
