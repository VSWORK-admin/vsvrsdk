...
[AkiInfo("Composite : Templete")]
[AkiLabel("GeneratedDllComposite : Templete")]
//[AkiGroup("GeneratedDllComposite")]
public class GeneratedDllComposite : Kurisu.AkiBT.Composite
{
    ...
    public DllCompositeBase DllClass
    {
        get
        {
            ...
            try
            {
                if (DllManager.appdomain == null && !string.IsNullOrEmpty(DllName.Value))
                {
                    if (MultiDllManager.Instance != null && MultiDllManager.Instance.AllDllInstance.ContainsKey(DllName.Value))
                    {
                        ...
                        {
                            GenClass = MultiDllManager.Instance.AllDllInstance[DllName.Value].appdomain.Instantiate<DllCompositeBase>(ScriptClassName.Value);
                        }
                ...
                else
                {
                    if (GenClass == null && !string.IsNullOrEmpty(ScriptClassName.Value))
                    {
                        GenClass = DllManager.appdomain.Instantiate<DllCompositeBase>(ScriptClassName.Value);
                    }
    ...
    private DllCompositeBase GenClass = null;
    ~GeneratedDllComposite()
    {
        if (GenClass != null)
        {
            GenClass = null;
