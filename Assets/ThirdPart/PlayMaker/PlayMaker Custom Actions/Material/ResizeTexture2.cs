...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Resize the texture with another method - Only works on ARGB32, RGB24 and Alpha8 textures that are marked readable")]
    [HelpUrl("http://hutonggames.com/playmakerforum/index.php?topic=12349.0")]
	public class ResizeTexture2 : FsmStateAction
	{
		[ActionSection("Input")]
