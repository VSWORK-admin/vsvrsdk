...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Send a string event to all the GameObjects within an arrayList.")]
	public class ArrayListSendStringEventToGameObjects : ArrayListActions
	{
		[ActionSection("Set up")]
		
		public FsmEventTarget test;
