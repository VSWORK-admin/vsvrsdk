...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Gets a full row from an ArrayTable and save it into an ArrayListProxy")]
	public class ArrayTableGetRowToArrayList : ArrayListActions
	{
		...
		public void GetRowAtIndex()
		{
			...
			try{
				...
				{
					proxy.arrayList.Add(_column.arrayList[atRowIndex.Value]);
				}
