...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class ArrayListRaycastAll : ArrayListActions
	{
        ...
        public FsmOwnerDefault storeHitsGameObject;
		...
		{
			SetUpArrayListProxyPointer(Fsm.GetOwnerDefaultTarget(storeHitsGameObject), reference.Value);
		...
		void DoRaycast()
		{
			...
			if (didHit)
			{
			    ...
			    {
				    this.proxy._arrayList.Clear();
				    foreach (GameObject gameObject in gameObjectsHit)
				    {
					    this.proxy._arrayList.Add(gameObject);
				    }
			    }
